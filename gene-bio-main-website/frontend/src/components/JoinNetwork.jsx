...
import prospectus from "../assets/images/GeneBio Healthcare Products_20240930_134047_0000.pdf";
          ...
          <div className="relative flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex w-full flex-col gap-4 lg:w-auto lg:flex-row lg:items-center lg:gap-5">
              ...
              <Link
                ...
                className="flex h-[54px] w-full items-center justify-center rounded-full bg-[#22BDF4] px-8 text-[15px] font-medium text-white transition duration-300 hover:scale-[1.02] lg:h-[60px] lg:w-auto lg:px-10 lg:text-[16px]"
              >
                Apply for Partnership
              </Link>
              ...
              <a
                href={prospectus}
                download="GeneBio-Healthcare-Prospectus.pdf"
                className="flex h-[54px] w-full items-center justify-center rounded-full border border-white/40 px-8 text-[15px] font-medium text-white transition duration-300 hover:bg-white hover:text-[#2F3132] lg:h-[60px] lg:w-auto lg:px-10 lg:text-[16px]"
              >
                Download Prospectus
              </a>
